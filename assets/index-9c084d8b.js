...
`),m.length>0&&(m+=`
`),h=[p,"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,g].filter(Zs).join(`
`),h.length>0&&(h+=`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
            ...
            de l'application.`,image:"./img/FastTrackauto.png",skills:["Flutter","Dart","Git","OBD2","MySQL","Java","Swift"],competences:[{competence:"Réaliser des applications",justification:"Je suis capable de réaliser des applications car dans le cadre de la réalisation du projet FastTrackAuto, j'ai su mettre en place une application mobile Flutter permettant de communiquer avec un module OBD2 pour récupérer les données de la voiture."},{competence:"Optimiser des applications",justification:"Je suis capable d'optimiser des applications car dans le cadre de la réalisation du projet FastTrackAuto, j'ai su mettre en place un système de cache pour stocker les données des utilisateurs et ainsi éviter de les récupérer à chaque fois. J'ai également réaliser plusieurs test de performance (Benchmark) pour optimiser les performances de l'application et ainsi réduire ua maximum son impact environnemental. Pour finir un système de gestion et de création d'itinéraire a été mis en place pour optimiser les trajets des utilisateurs à partir de son utilisation personnel afin de pouvoir limiter son empreinte carbonique."},{competence:"Administrer des Systèmes",justification:"Je suis capable d'administrer des systèmes informatique car dans le cadre de la réalisation du projet FastTrackAuto, j'ai su mettre en place un serveur dédié pour héberger la base de donnée MySQL. J'ai également pu mettre en place un système de sauvegarde automatique des données pour éviter toute perte de données. Également un système de transmission par OBD2 à du être déveloper car largement sous exploiter actuellement et permettant d'optimiser les envoie de code PID à la voiture."},{competence:"Gérer des données",justification:"Je suis capable de gérer des données divers car dans le cadre de la réalisation du projet FastTrackAuto, j'ai su mettre en place une base de donnée MySQL pour stocker les données des utilisateurs. J'ai également pu mettre en place un système de cache pour stocker les données des utilisateurs et ainsi éviter de les récupérer à chaque fois."}],left:!1},null,8,["competences"]),Ye($s,{title:"PortfolioV3",github:"https://github.com/maximefurious/PorteFolioV3",date:"2022 - 2023",description:`Ce projet représente la troisième version de mon portfolio. Il a été réaliser à la suite du projet PortfolioV2
            et il a été réaliser dans le but de découvre l'environnement ReactJS et de pouvoir comparer l'environnement natif et ReactJS.
            Ce projet est également l'occasion de découvrir les principes fondamentaux du GreenIT et de les appliquer dans le développement.`,image:"./img/PortfolioV3.png",skills:["React","Git","Ajax","GreenIT"],left:!0,competences:[{competence:"Réaliser des applications",justification:"Je suis capable de réaliser des applications car dans le cadre de la réalisation du projet PortfolioV3, j'ai su mettre en place un site internet basé sur le framework ReactJS. Ce site internet à également fait l'objet d'une mise en production car il était présent et accessible à tous via un navigateur web. Ce site internet est également la continuité et l'évolution de deux autres PortFolio réalisé précédemment."},{competence:"Optimiser des applications",justification:"Je suis capable d'optimiser des applications car dans le cadre de la réalisation du projet PortfolioV3, j'ai su mettre en place des outils d'analyse afin de pouvoir avoir un site internet respectant le GreenIT. Une grande partie de l'optimisation a été faite sur le serveur pour réduire la consommation énergétique."}]},null,8,["competences"]),Ye($s,{title:"PortfolioV4",github:"https://github.com/maximefurious/PorteFolio",date:"2023 - Aujourd'hui",description:`Ce projet représente la quatrième version de mon portfolio. Il a été réaliser dans le contexte de la découverte
